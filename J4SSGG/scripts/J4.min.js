var J4=function(b,a){this.canvas=document.getElementById(b);this.canvas.width=window.innerWidth;this.canvas.height=window.innerHeight;this.ctx=this.canvas.getContext("2d");this.width=this.canvas.width;this.height=this.canvas.height;this.lineColor=this.dotColor="#E8444D";this.showDots=this.showLines=!0;this.dots=[];this.amount=20;this.yVelocity=this.xVelocity=5;this.dotWidth=4;this.lineWidth=.25;this.highestPath=0;this.size=3;void 0!==a&&(void 0!==a.dotColor&&(this.dotColor=a.dotColor),void 0!==
a.lineColor&&(this.lineColor=a.lineColor),void 0!==a.lineWidth&&(this.lineWidth=.25*a.lineWidth),void 0!==a.dotWidth&&(this.dotWidth=a.dotWidth),void 0!==a.amount&&(this.amount=a.amount),void 0!==a.xVelocity&&(this.xVelocity=a.xVelocity),void 0!==a.yVelocity&&(this.yVelocity=a.yVelocity),void 0!=a.showDots&&(this.showDots=a.showDots),void 0!=a.showLines&&(this.showLines=a.showLines),void 0!=a.size&&(this.size=a.size));this.initialize()};
...
J4.prototype.random=function(b,a){return Math.random()*(a-b)+b};J4.prototype.negativeRandom=function(){return.5>Math.random()?-1:1};J4.prototype.compare=function(b,a){return b.distance<a.distance?-1:b.distance==a.distance?0:1};J4.prototype.distances=function(){if(this.showLines)for(var b=0;b<this.amount;b++){this.dots[b].neighbors=[];for(var a=0;a<this.amount;a++){var c=this.euclideanDistance(this.dots[b],this.dots[a]);0!=c&&this.dots[b].neighbors.push({id:this.dots[a].id,distance:c})}this.dots[b].neighbors.sort(this.compare)}};
